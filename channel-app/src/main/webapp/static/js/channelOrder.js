...
function addItemInTable(){
  ...
  var row = '<tr>'
  + '<td style="word-break: break-all;max-width: 0px;">' + data.clientSkuId + '</td>'
  + '<td style="word-break: break-all;max-width: 0px;">' + data.channelSkuId + '</td>'
  + '<td style="word-break: break-all;max-width: 0px;">'  + data.productName + '</td>'
  + '<td style="word-break: break-all;max-width: 0px;">' + data.brandId + '</td>'
  + '<td>' + quantity + '</td>'
